...
class Editor
{
    ...
    public function iframe_assets()
    {
        ...
        Vite::assets()->enqueue('resources/integration/oxygen-classic/iframe/main.js', ['handle' => $handle, 'in_footer' => \true]);
    }
    public function editor_assets()
    {
        $handle = WIND_PRESS::WP_OPTION . ':integration-oxygen-classic-editor';
        Vite::assets()->enqueue('resources/integration/oxygen-classic/editor/main.js', ['handle' => $handle, 'in_footer' => \true]);
        wp_localize_script($handle, 'windpressoxygen', ['_version' => WIND_PRESS::VERSION, 'assets' => ['url' => Vite::base_url()], 'site_meta' => ['name' => get_bloginfo('name'), 'site_url' => get_site_url(), 'admin_url' => AdminPage::get_page_url()]]);
