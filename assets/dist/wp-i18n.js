(() => {
	...
	__('A file scan requires an object payload.', 'windpress');
	__('Provide between one and 100 source patterns and at most 100 exclusions.', 'windpress');
	__('The file scan batch option must be a boolean.', 'windpress');
	__('Indexed file scans require batching.', 'windpress');
	__('The source revision must be a nonempty string.', 'windpress');
	__('Source data changed. Restart the scan.', 'windpress');
	__('The cache payload is invalid.', 'windpress');
	__('The cache content is not valid base64.', 'windpress');
	__('Another cache build is being saved. Retry the build.', 'windpress');
	__('The scan generation has changed. Restart the build.', 'windpress');
	__('Source content changed during the scan. Restart the build.', 'windpress');
	__('Save cache error: ', 'windpress');
	__('The scan request is invalid.', 'windpress');
	__('The provider not found', 'windpress');
	__('This provider does not support source indexing.', 'windpress');
	...
	__('The provider metadata and contents must be arrays.', 'windpress');
	__('A scan source is missing its content.', 'windpress');
	__('A scan source could not be encoded as text.', 'windpress');
	__('Unable to initialize the scan generation.', 'windpress');
	__('Unable to save the scan generation.', 'windpress');
	__('A scanner returned an invalid file path.', 'windpress');
	__('A source file no longer exists: ', 'windpress');
	__('The source directory does not exist.', 'windpress');
	__('Allowed source directories must be an array.', 'windpress');
	__('Allowed source directories must contain paths.', 'windpress');
	__('File scan limits must be positive.', 'windpress');
	__('The file scan cursor is invalid.', 'windpress');
	__('This file scan is already processing a batch. Retry the same cursor.', 'windpress');
	__('The file scan expired or its sources changed. Start a new scan.', 'windpress');
	__('The file scan cursor is out of sequence. Start a new scan.', 'windpress');
	__('A source file cannot be read: ', 'windpress');
	__('The source file size could not be read: ', 'windpress');
	__('A source file exceeds the scan byte limit: ', 'windpress');
	__('A source file could not be read: ', 'windpress');
	__('The file scan lease expired. Retry the same cursor.', 'windpress');
	__('The file scan continuation could not be saved.', 'windpress');
	__('A source directory could not be read: ', 'windpress');
	__('A source path no longer exists: ', 'windpress');
	__('A source symlink points outside the allowed directories: ', 'windpress');
	__('Source patterns must be nonempty strings up to 4096 bytes.', 'windpress');
	__('Source patterns must stay within the source directory.', 'windpress');
	__('Source patterns must not be empty.', 'windpress');
	__('A source pattern is invalid.', 'windpress');
	__('The post scan cursor is invalid. Restart the scan.', 'windpress');
	__('The post scan page is invalid.', 'windpress');
	__('Unable to initialize the post scan.', 'windpress');
	__('Unable to read a post scan batch.', 'windpress');
	__('A query filter changed the scan batch limits. Exclude WindPress scans from that filter.', 'windpress');
	__('A query filter changed the scan ordering. Exclude WindPress scans from that filter.', 'windpress');
	__('Could not set up the post context.', 'windpress');
	__('The renderer must return a string.', 'windpress');
	__('%1$s could not render post #%2$d: %3$s', 'windpress');
	__('The source index request is invalid.', 'windpress');
	__('The source index cursor is invalid.', 'windpress');
	__('This source scan is already processing. Retry the same cursor.', 'windpress');
	__('The source scan expired or its context changed. Restart the build.', 'windpress');
	__('The source cursor is out of sequence. Restart the build.', 'windpress');
	__('The indexed provider returned an invalid response.', 'windpress');
	__('An indexed source requires a stable ID and text content.', 'windpress');
	__('The provider returned a duplicate source ID: ', 'windpress');
	__('The indexed provider returned an invalid cursor.', 'windpress');
	__('The indexed provider repeated a cursor.', 'windpress');
	__('The source scan lease expired. Restart the build.', 'windpress');
	__('Another scan is saving its source manifest. Retry the same cursor.', 'windpress');
	__('Unable to save the source index. Restart the build.', 'windpress');
	__('Unable to initialize the source revision.', 'windpress');
	...
	__('The snippet scan cursor is invalid. Restart the scan.', 'windpress');
	__('The snippet scan page is invalid.', 'windpress');
	__('Unable to initialize the snippet scan.', 'windpress');
	__('Unable to read a snippet scan batch.', 'windpress');
